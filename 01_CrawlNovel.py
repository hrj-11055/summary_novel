...
async def main():
    # 确保输出目录存在
    output_dir = r"C:\Users\Administrator\Desktop\summary_novel\1_meinv"  # 不要有汉字 路径中不能有汉字
    os.makedirs(output_dir, exist_ok=True)
    
    async with AsyncWebCrawler() as crawler:
        for i in range(1500,1665):  # 爬取第1章到第1818章的页面    直接复制你小说网站的url，然后把后面的数字替换成{i}
            ...
            url = f"https://www.beqege.cc/16745/22326{i}.html"
            try:
