...
def merge_txt_files():
    # 设置输入和输出目录路径
    input_dir = r"C:\Users\Administrator\Desktop\summary_novel\2_xianni_yuanwen"
    output_dir = r"C:\Users\Administrator\Desktop\summary_novel\3_merge_chapters_xianni"
